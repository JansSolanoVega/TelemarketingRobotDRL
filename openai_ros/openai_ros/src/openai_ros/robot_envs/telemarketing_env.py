...
class TelemarketingEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self, ros_ws_abspath):
        ...
        * /scan: Laser Readings
        ...
        Args:
        """
        rospy.logdebug("Start Telemarketing INIT...")
        ...
        super(TelemarketingEnv, self).__init__(controllers_list=self.controllers_list,
        ...
        rospy.logdebug("Finished TelemarketingEnv INIT...")
    ...
    def move_base(self, linear_speed, angular_speed, epsilon=0.05, update_rate=10, min_laser_distance=-1):
        ...
        rospy.logdebug("Telemarketing Base Twist Cmd>>" + str(cmd_vel_value))
        self._check_publishers_connection()
    ...
    def wait_until_twist_achieved(self, cmd_vel_value, epsilon, update_rate, min_laser_distance=-1):
        ...
        while not rospy.is_shutdown():
            ...
            if crashed_into_something:
                rospy.logerr("Telemarketing has crashed, stopping movement!")
                break
                ...
                if item == float ('Inf') or numpy.isinf(item):
                   ...
                   pass
                    ...
                    if (item < min_laser_distance):
                        rospy.logerr("Telemarketing HAS CRASHED >>> item=" + str(item)+"< "+str(min_laser_distance))
